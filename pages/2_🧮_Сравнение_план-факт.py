...
st.dataframe(
                ...
                .apply(lambda x: ['background-color: ; opacity: 0.1' if x.name == 'Показы, %' and value == 0 else '' for col_i, value in enumerate(x)], axis = 0)
                ...
                .apply(lambda x: ['background-color: ; opacity: 0.1' if x.name == 'Клики, %' and value == 0 else '' for col_i, value in enumerate(x)], axis = 0)
                ...
                .apply(lambda x: ['background-color: ; opacity: 0.1' if x.name == 'Конверсии, %' and value == 0 else '' for col_i, value in enumerate(x)], axis = 0)
                ...
                .apply(lambda x: ['background-color: ; opacity: 0.1' if x.name == 'Охват, %' and value == 0 else '' for col_i, value in enumerate(x)], axis = 0)
                ...
                .apply(lambda x: ['background-color: ; opacity: 0.1' if x.name == 'CPM, %' and value == 0 else '' for col_i, value in enumerate(x)], axis = 0)
                .format(precision=0, thousands=' ', subset=num_format)
                .format('{:.1f}%', thousands=' ', subset=num_format_perc)
                .format('$ {:.1f}', thousands=' ', subset=nun_format_money),
